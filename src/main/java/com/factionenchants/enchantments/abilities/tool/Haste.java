...
/**
 * Haste III — Tool enchantment, SIMPLE tier.
 * Allows you to swing your tools faster by applying Haste while the tool is held.
 */
public class Haste extends CustomEnchantment {
    ...
    public void onTickPassive(Player player, int level, ItemStack equipment) {
        player.addPotionEffect(new PotionEffect(
                PotionEffectType.FAST_DIGGING, 40, level - 1, false, false));
    }
}
